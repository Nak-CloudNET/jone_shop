...
function loadItems() {
	...
	if (localStorage.getItem('positems')) {
		...
		if(java_applet == 1) {
			...
			var pos_bill_head = '';
				...
				pos_bill_head += '<table style="width:100% !important;font-family: MS Reference Sans Serif; font-size: 13px;"><tr><td>Date: '+currentDate+'</td><td>Time: '+formattedDate3+'</td></tr><tr><td>Terminal:</td><td></td></tr><tr><td>Partner:</td><td></td></tr><tr><td>Table: '+ $("#suspend_name").val() +'</td><td></td></tr><tr><td>Customer: '+$('#select2-chosen-1').text()+'</td</tr><tr><td>Ref no. : '+ reference_no +'</td></tr></table>';
		...
		$.each(positems, function (i, e) {
			...
			if (ds.indexOf("%") !== -1) {
				...
				if (!isNaN(pds[0])) {
					item_discount = (parseFloat(((unit_price) * parseFloat(pds[0])) / 100));product_discount += parseFloat(item_discount*item_qty);  	
			...
			if (item_type == 'standard' && item.options !== false) {
				...
				if(n == 1){
				var table_b = '<tr style="font-family: MS Reference Sans Serif; font-size: 13px;">';
					table_b +=  '				<th>Items name</th>';
					table_b +=  '				<th>Qty</th>';
				...
				bprTr += '<td style="width:80% !important; font-family: MS Reference Sans Serif; font-size: 13px; padding-bottom:5px">'+ (an-1) + ' ' + item_name+'</td>';
				bprTr += '<td style="text-align:center; font-family: MS Reference Sans Serif; font-size: 13px;">'+ currencyFormat(item_qty) +'</td>';
				bprTr += '<td style="text-align:right;font-family: MS Reference Sans Serif; font-size: 13px;">'+ bill_amount +'</td>';
				bprTr += '</tr>';
	...
	if(susp_id > 0){
		...
		if(java_applet == 1) {
			...
			bill_totals += '<td style="text-align:right;"></td><td style="text-align:right;font-family: MS Reference Sans Serif; font-size: 13px;">$ '+formatMoney(total_discount)+'</td></tr>';
			...
			bill_totals += '<td style="text-align:right; border-bottom: 1px solid #000 !important"></td><td style="text-align:right;font-family: MS Reference Sans Serif; font-size: 13px; border-bottom: 1px solid #000 !important">$ '+formatMoney(product_tax)+'</td></tr>';

			bill_totals += '<tr><td colspan="3" style="font-family: MS Reference Sans Serif; font-size: 13px;">Cash (USD)</td>';
			bill_totals += '<td style="text-align:right;"></td><td style="text-align:right;font-family: MS Reference Sans Serif; font-size: 13px;">$ '+ formatMoney(total - total_discount) +'</td></tr>';

			bill_totals += '<tr><td colspan="3" style="font-family: MS Reference Sans Serif; font-size: 13px;">Cash (RIEL)</td>';
			bill_totals += '<td style="text-align:right;"></td><td style="text-align:right;font-family: MS Reference Sans Serif; font-size: 13px;">R '+formatMoney((total - total_discount)*kh_rate)+'</td></tr>';
