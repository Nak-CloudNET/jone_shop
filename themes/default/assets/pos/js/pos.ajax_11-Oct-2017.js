	...
	if (localStorage.getItem('positems')) {
		...
		if(java_applet == 1) {
			...
			var pos_bill_head = '';
				...
				pos_bill_head += '<table style="width:100% !important;font-family: MS Reference Sans Serif; font-size: 13px;"><tr><td>Date: '+currentDate+'</td><td>Time: '+formattedDate3+'</td></tr><tr><td>Terminal:</td><td></td></tr><tr><td>Partner:</td><td></td></tr><tr><td>Table: '+ $("#suspend_name").val() +'</td><td></td></tr><tr><td>Customer: '+$('#select2-chosen-1').text()+'</td</tr></table>';
