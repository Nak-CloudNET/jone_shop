...
function loadItems() {
	...
	if (localStorage.getItem('positems')) {
		...
		if(java_applet == 1) {
			...
			var pos_bill_head = '<table style="width:100% !important;font-family: MS Reference Sans Serif; font-size: 13px;"><tr><td>Date: '+currentDate+'</td><td>Time: '+formattedDate3+'</td></tr><tr><td>Terminal:</td><td></td></tr><tr><td>Partner:</td><td></td></tr><tr><td>Table: '+ $("#suspend_name").val() +'</td><td></td></tr><tr><td>Customer: '+$('#select2-chosen-1').text()+'</td</tr></table>';
			// var pos_bill_head = '<p style="font-family: MS Reference Sans Serif; font-size: 13px;">Date: '+formattedDate2+'<br/>Terminal: <br/>Partner: <br/>Table: <br/>Customer: '+$('#select2-chosen-1').text()+'</p>';
		...
		$.each(positems, function (i, e) {
			...
			if (item_type == 'standard' && item.options !== false) {
				...
				//alert((item_id && help == 0) +"###"+ item_id +"###"+ help);
				if(item_type_by!="")
				{
					if(item_type_by=='food' && item_print==0)
					{
						...
						if(item_id && help1 == 0) {
							oprTr1 += '<tr style="border-bottom: 1px solid #000; "><td>&nbsp;&nbsp;Items name</td><td>Qty</td></tr>';
							help1 = 1;
						}
						
						oprTr1 += '<tr style="font-weight:bold" class="row_' + item_id + ' order_print_food " itemcode="'+item_code+'" data-item-id="' + item_id + '"><td>#'+(an-1)+' ' + item_name + (item_note? '['+item_note+']':"") +'</td><td>' + formatDecimal(item_qty) +'</td></tr>';
					...
					}else if(item_type_by=='drink' && item_print==0)
					{
						var oprTr2 = '';
						if(item_id && help2 == 0) {
							oprTr2 += '<tr style="border-bottom: 1px solid #000; "><td>&nbsp;&nbsp;Items name</td><td>Qty</td></tr>';
							help2 = 1;
						}
						oprTr2 += '<tr style="font-weight:bold" class="row_' + item_id + ' order_print_drink " itemcode="'+item_code+'" data-item-id="' + item_id + '"><td>#'+(an-1)+' ' + item_name +  (item_note? '['+item_note+']':"") +'</td><td>' + formatDecimal(item_qty) +'</td></tr>';
