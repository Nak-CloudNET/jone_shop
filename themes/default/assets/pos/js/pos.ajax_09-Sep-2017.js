...
function loadItems() {
				...
				if(item_type_by!="")
				{
					if(item_type_by=='food' && item_print==0)
					{
						...
						if(an-1==1){
							...
							oprTr += '<tr style="border-bottom: 1px solid #000;font-weight:bold;"><td>&nbsp;&nbsp;Items name</td><td>Qty</td></tr>';
						}
						
						oprTr += '<tr style="font-weight:bold" class="row_' + item_id + ' order_print_food " itemcode="'+item_code+'" data-item-id="' + item_id + '"><td>#'+(an-1)+' ' + item_name + (item_note? '['+item_note+']':"") +'</td><td>' + formatDecimal(item_qty) +'</td></tr>';
					...
					}else if(item_type_by=='drink' && item_print==0)
					{
						...
						oprTr += '<tr style="font-weight:bold" class="row_' + item_id + ' order_print_drink " itemcode="'+item_code+'" data-item-id="' + item_id + '"><td>#'+(an-1)+' ' + item_name +  (item_note? '['+item_note+']':"") +'</td><td>' + formatDecimal(item_qty) +'</td></tr>';
	...
	if(susp_id > 0){
		...
		if(java_applet == 1) {
			...
			bill_totals += '<tr><td colspan="5" style="text-align:center; font-family: MS Reference Sans Serif; font-size: 13px;"><p>Free WIFI access code:</p></td></tr>';
