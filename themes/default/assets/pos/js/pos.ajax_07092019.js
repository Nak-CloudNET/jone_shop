...
function loadItems() {
			...
			if (item_type == 'standard' && item.options !== false) {
				...
				if(item_type_by!="")
				{
					if(item_type_by=='food' && item_print==0)
					{
						...
						oprTr1 += '<tr style="font-weight:bold" class="row_' + item_id + ' order_print_food " itemcode="'+item_code+'" data-item-id="' + item_id + '"><td style="width:50% !important"><span style="font-size:11px !important;">-</span> ' + item_name + (item_note? '['+item_note+']':"") +'</td><td style="width:50% !important; text-align:right !important">' + formatDecimal(item_qty) +'</td></tr>';
					...
					}else if(item_type_by=='drink' && item_print==0)
					{
						...
						oprTr2 += '<tr style="font-weight:bold" class="row_' + item_id + ' order_print_drink " itemcode="'+item_code+'" data-item-id="' + item_id + '"><td style="width:50% !important"><span style="font-size:11px !important;">-</span> ' + item_name +  (item_note? '['+item_note+']':"") +'</td><td style="width:50% !important; text-align:right !important">' + formatDecimal(item_qty) +'</td></tr>';
	...
	if(susp_id > 0){
		...
		if(java_applet == 1) {
			...
			bill_totals += '<tr><td colspan="3" style="font-family: MS Reference Sans Serif; font-size: 13px;">VAT</td>';
			bill_totals += '<td style="text-align:right;"></td><td style="text-align:right;font-family: MS Reference Sans Serif; font-size: 13px;">$ '+formatMoney(product_tax)+'</td></tr>';
