...
$(document).ready(function() {
	...
	$('body').on('click', '.purchase_order_links td:not(:first-child :last-child)', function() {
	...
	$('body').on('click', '.invoice_links td:not(:first-child :last-child)', function() {
    ...
    $('body').on('click', '.delivery_link td:not(:first-child, :last-child)', function() {
		$('#myModal2').modal({remote: site.base_url + 'sales/view_delivery/' + $(this).parent('.delivery_link').attr('id')});
        $('#myModal2').modal('show');
    });
