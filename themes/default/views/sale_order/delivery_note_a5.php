...
<body>
<div class="container-fluid print_rec" id="wrap" style="margin: 0 auto;">
<?php for ($i = 1; $i <= 2; $i++) { ?>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="row padding10">
                <div class="col-xs-5" style="float: left;font-size:12px">
                    <table>
                        <tr>
                            <td>
                                <p><?= lang("customer");?></p>
                ...
                <div class="col-xs-5"  style="float: right;font-size:12px">
                    <table>
                        <tr>
                            <td>
                ...
                <table class="table table-bordered table-hover table-striped" style="width: 100%;">
                    ...
                    <tbody style="font-size: 13px;">
                       ...
                       <?php foreach($inv_items as $inv_item) { ?>
                            ...
                            ?>
							<tr>
								<td style="text-align:center; width:5%; vertical-align:middle;border-top:none !important;border-bottom:none !important;"><?= $no; ?></td>
								<?php if($setting->show_code == 1 && $setting->separate_code == 1) { ?>
								<td style="vertical-align:middle; width:15%;border-top:none !important;border-bottom:none !important;" >
									<?= $inv_item->code ?>
								</td>
								<?php } ?>
								<td style="vertical-align:middle;width:30%;border-top:none !important;border-bottom:none !important;">
									<?= $inv_item->description?>
								</td>
                                <td style="vertical-align:middle;width:30%;border-top:none !important;border-bottom:none !important;" class="text-center" >
                                    <?= $str_unit ?>
                                </td>
                                <td style="vertical-align:middle;width:30%;border-top:none !important;border-bottom:none !important;" class="text-center">
                            ...
                            if ($row < 6) {
                                ...
                                for ($j=1; $j <= $k; $j++) {
                                    ...
                                    echo
                                        '<tr>
                                            <td height="34px" style="text-align:center; width:5%; vertical-align:middle;border-top:none !important;border-bottom:none !important;">'.$no.'</td>
            ...
            <br>
            <div class="row">
                    <div class="col-lg-3 col-xs-3" style="font-size: 10px">
                        <p class="bold">
                            Receive by <br>
                            អ្នកទទួលទំនិញ
                        </p>
                    ...
                    <div class="col-lg-1"></div> -->
                    <div class="col-lg-3 col-xs-3" style="font-size: 10px; padding-left: 10px !important">
                        <p class="bold">
                            stock_keeper/issued_by <br>
                            អ្នកបញ្ជេញទំនិញ
                        </p>
                        <br><br>
                        <p style="border-top: 1px solid #666;"></p>
