        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row">
					...
					<!--
					<fieldset class="scheduler-border">
                        <legend class="scheduler-border"><?= lang('terms') ?></legend>
						
						<div class="col-md-12">
							<div class="col-md-4">
								<div class="form-group">
									<?= lang("academic_year", "academic_year"); ?>
									<?php
									echo form_input('academic_year', '', 'class="form-control tip" id="academic_year"');
									?>
								</div>
							</div>
                        </div>
                        ...
                        <div class="col-md-12">
							<div class="col-md-4">
								<div class="form-group">
									<?= lang("term1", "term1"); ?></label>
									<?php echo form_input('term1', '', 'class="form-control tip" id="term1"'); ?>
								</div>
							</div>
							
							<div class="col-md-4">
								<div class="form-group">
									<?= lang("start_term", "start_term1"); ?>
									<?php echo form_input('start_term1', '', 'class="form-control date" id="datepicker start_term1"'); ?>
								</div>
							</div>
							
							<div class="col-md-4">
								<div class="form-group">
									<?= lang("end_term", "end_term1"); ?>
									<?php echo form_input('end_term1', '', 'class="form-control date" id="datepicker end_term1"'); ?>
								</div>
							</div>
                        </div>
                        ...
                        <div class="col-md-12">
							<div class="col-md-4">
								<div class="form-group">
									<?= lang("term2", "term2"); ?></label>
									<?php echo form_input('term2', '', 'class="form-control tip" id="term2"'); ?>
								</div>
							</div>
							
							<div class="col-md-4">
								<div class="form-group">
									<?= lang("start_term", "start_term2"); ?>
									<?php echo form_input('start_term2', '', 'class="form-control date" id="datepicker start_term2"'); ?>
								</div>
							</div>
							
							<div class="col-md-4">
								<div class="form-group">
									<?= lang("end_term", "end_term2"); ?>
									<?php echo form_input('end_term2', '', 'class="form-control date" id="datepicker end_term2"'); ?>
								</div>
							</div>
                        </div>
                        ...
                        <div class="col-md-12">
							<div class="col-md-4">
								<div class="form-group">
									<?= lang("term3", "term3"); ?></label>
									<?php echo form_input('term3', '', 'class="form-control tip" id="term3"'); ?>
								</div>
							</div>
							
							<div class="col-md-4">
								<div class="form-group">
									<?= lang("start_term", "start_term3"); ?>
									<?php echo form_input('start_term3', '', 'class="form-control date" id="datepicker start_term3"'); ?>
								</div>
							</div>
							
							<div class="col-md-4">
								<div class="form-group">
									<?= lang("end_term", "end_term3"); ?>
									<?php echo form_input('end_term3', '', 'class="form-control date" id="datepicker end_term3"'); ?>
								</div>
							</div>
                        </div>
                        ...
                        <div class="col-md-12">
							<div class="col-md-4">
								<div class="form-group">
									<?= lang("term4", "term4"); ?></label>
									<?php echo form_input('term4', '', 'class="form-control tip" id="term4"'); ?>
								</div>
							</div>
							
							<div class="col-md-4">
								<div class="form-group">
									<?= lang("start_term", "start_term4"); ?>
									<?php echo form_input('start_term4', '', 'class="form-control date" id="datepicker start_term4"'); ?>
								</div>
							</div>
							
							<div class="col-md-4">
								<div class="form-group">
									<?= lang("end_term", "end_term4"); ?>
									<?php echo form_input('end_term4', '', 'class="form-control date" id="datepicker end_term4"'); ?>
								</div>
							</div>
                        </div>
                    </fieldset>
