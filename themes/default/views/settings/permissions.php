                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>
									   <div class="container-fluid ">
											...
											<div class="col-md-6">
												<input type="checkbox" value="1" id="products-items_convert" class="checkbox"
													name="products-items_convert" <?php echo $p->{'products-items_convert'} ? "checked" : ''; ?>><label
													for="products-items_convert" class="padding05"><?= lang('Items Convert') ?></label>
											</div>
											<div class="col-md-6">
												<input type="checkbox" value="1" id="products-print_barcodes" class="checkbox"
													name="products-print_barcodes" <?php echo $p->{'products-print_barcodes'} ? "checked" : ''; ?>><label
													for="products-print_barcodes" class="padding05"><?= lang('Print Barcodes') ?></label>
											</div>
											<div class="col-md-6">
												<input type="checkbox" value="1" id="products-using_stock" class="checkbox"
													name="products-using_stock" <?php echo $p->{'products-using_stock'} ? "checked" : ''; ?>><label
													for="products-using_stock" class="padding05"><?= lang('Using Stock') ?></label>
											</div>
											<div class="col-md-6">
													<input type="checkbox" value="1" id="products-list_using_stock" class="checkbox"
														name="products-list_using_stock" <?php echo $p->{'products-list_using_stock'} ? "checked" : ''; ?>><label
														for="products-list_using_stock" class="padding05"><?= lang('List Using Stock') ?></label>
											</div>
											<!-- <div class="col-md-6">
											...
											<div class="col-md-6">
													<input type="checkbox" value="1" id="products-import_quantity" class="checkbox"
														name="products-import_quantity" <?php echo $p->{'products-import_quantity'} ? "checked" : ''; ?>><label
														for="products-import_quantity" class="padding05"><?= lang('import_quantity') ?></label>
											</div>
											<div class="col-md-6">
													<input type="checkbox" value="1" id="products-import_price_cost" class="checkbox"
														name="products-import_price_cost" <?php echo $p->{'products-import_price_cost'} ? "checked" : ''; ?>><label
														for="products-import_price_cost" class="padding05"><?= lang('Import Price Cost') ?></label>
											</div>
											<div class="col-md-6">
													<input type="checkbox" value="1" id="products-return_list" class="checkbox"
														name="products-return_list" <?php echo $p->{'products-return_list'} ? "checked" : ''; ?>><label
														for="products-return_list" class="padding05"><?= lang('return_list') ?></label>
											</div>
											<div class="col-md-6">
													<input type="checkbox" value="1" id="products-sync_quantity" class="checkbox"
														...
														for="products-sync_quantity" class="padding05"><?= lang('products-sync_quantity') ?></label>
											</div>
								...
								<tr>
									...
									<td>
										<div class="container-fluid">
											<div class="col-md-4"> 
												<input type="checkbox" value="1" id="sale_order-authorize" class="checkbox"
													   name="sale_order-authorize" <?php echo $p->{'sale_order-authorize'} ? "checked" : ''; ?>><label
													for="sale_order-authorize" class="padding05"><?= lang('authorize') ?></label>
											</div>
											<div class="col-md-4"> 
												<input type="checkbox" value="1" id="sale_order-price" class="checkbox"
													   name="sale_order-price" <?php echo $p->{'sale_order-price'} ? "checked" : ''; ?>><label
													for="sale_order-price" class="padding05"><?= lang('price') ?></label>
											</div>
											<div class="col-md-4"> 
												<input type="checkbox" value="1" id="sale_order-combine_pdf" class="checkbox"
													   name="sale_order-combine_pdf" <?php echo $p->{'sale_order-combine_pdf'} ? "checked" : ''; ?>><label
													for="sale_order-combine_pdf" class="padding05"><?= lang('combine_pdf') ?></label>
											</div>
											<div class="col-md-4"> 
												<input type="checkbox" value="1" id="sale_order-deposit" class="checkbox"
													   name="sale_order-deposit" <?php echo $p->{'sale_order-deposit'} ? "checked" : ''; ?>><label
													for="sale_order-deposit" class="padding05"><?= lang('deposit') ?></label>
											</div>
										</div>
									</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
									    <div class="container-fluid">
											...
											<div class="col-md-4">
													<input type="checkbox" value="1" id="sales-combine_pdf" class="checkbox"
														   name="sales-combine_pdf" <?php echo $p->{'sales-combine_pdf'} ? "checked" : ''; ?>><label
														for="sales-combine_pdf"
														class="padding05"><?= lang('combine_pdf') ?></label>
											</div>
											<div class="col-md-4">
													<input type="checkbox" value="1" id="customer_balance" class="checkbox"
														   name="customer_balance" <?php echo $p->{'customers_balance'} ? "checked" : ''; ?>><label
                                ...
                                <tr>
									...
									<td>
                                        <div class="container-fluid" style="padding-left:30px;">
											<input type="checkbox" value="1" id="sales-combine_delivery" class="checkbox"
												   name="sales-combine_delivery" <?php echo $p->{'sales-combine_delivery'} ? "checked" : ''; ?>><label
												for="sales-combine_delivery" class="padding05"><?= lang('combine_delivery') ?></label>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="container-fluid" style="padding-left:30px;">
											<input type="checkbox" value="1" id="quotes-authorize" class="checkbox"
												   name="quotes-authorize" <?php echo $p->{'quotes-authorize'} ? "checked" : ''; ?>><label
												for="quotes-authorize" class="padding05"><?= lang('authorize') ?></label>
											...
											<input type="checkbox" value="1" id="quotes-conbine_pdf" class="checkbox"
												   name="quotes-conbine_pdf" <?php echo $p->{'quotes-conbine_pdf'} ? "checked" : ''; ?>><label
												for="quotes-conbine_pdf" class="padding05"><?= lang('combine_pdf') ?></label>
                                ...
                                <tr>
                                    ...
                                    <td>
									     <div class="container-fluid" >
											...
											<div class="col-md-6">
													<input type="checkbox" value="1" id="purchases-add_expenses" class="checkbox"
														   name="purchases-add_expenses" <?php echo $p->{'purchases_add-expenses'} ? "checked" : ''; ?>><label
														for="purchases-add_expenses" class="padding05"><?= lang('add_expenses') ?></label>
											</div>
											<div class="col-md-6">
											...
											<div class="col-md-6">
													<input type="checkbox" value="1" id="purchases-combine_pdf" class="checkbox"
														   name="purchases-combine_pdf" <?php echo $p->{'purchases-combine_pdf'} ? "checked" : ''; ?>><label
														for="purchases-combine_pdf" class="padding05"><?= lang('combine_pdf') ?></label>
											</div>
											<div class="col-md-6">
													<input type="checkbox" value="1" id="purchases-supplier_balance" class="checkbox"
														   name="purchases-supplier_balance" <?php echo $p->{'purchases-supplier_balance'} ? "checked" : ''; ?>><label
														for="purchases-supplier_balance" class="padding05"><?= lang('supplier_balance') ?></label>
											</div>
										 </div>
                                    </td>
                                </tr>
								...
								<tr>
									...
									<td>
									  <div class="container-fluid" style="padding-left:30px;">
										...
										<!--<input type="checkbox" value="1" id="purchase_order-import_expanse" class="checkbox"
                                               name="purchase_order-import_expanse" <?php echo $p->{'purchase_order-import_expanse'} ? "checked" : ''; ?>><label
                                            for="purchase_order-import_expanse" class="padding05"><?= lang('import_expanse') ?></label>
										<input type="checkbox" value="1" id="purchase_order-combine_pdf" class="checkbox"
                                               name="purchase_order-combine_pdf" <?php echo $p->{'purchase_order-combine_pdf'} ? "checked" : ''; ?>><label
                                            for="purchase_order-combine_pdf" class="padding05"><?= lang('combine_pdf') ?></label>-->
                                        <input type="checkbox" value="1" id="purchase_order-authorize" class="checkbox"
                                               name="purchase_order-authorize" <?php echo $p->{'purchase_order-authorize'} ? "checked" : ''; ?>><label
                                            for="purchase_order-authorize" class="padding05"><?= lang('authorize') ?></label>
							    ...
							    <tr>
									...
									<td>
									     <div class="container-fluid" style="padding-left:30px;">
											...
											<!--<input type="checkbox" value="1" id="purchase_request-import_expanse" class="checkbox"
												   name="purchase_request-import_expanse" <?php echo $p->{'purchase_request-import_expanse'} ? "checked" : ''; ?>><label
												for="purchase_request-import_expanse" class="padding05"><?= lang('import_expanse') ?></label>
											<input type="checkbox" value="1" id="purchase_request-combine_pdf" class="checkbox"
												   name="purchase_request-combine_pdf" <?php echo $p->{'purchase_request-combine_pdf'} ? "checked" : ''; ?>><label
												for="purchase_request-combine_pdf" class="padding05"><?= lang('combine_pdf') ?></label>-->
											<input type="checkbox" value="1" id="purchase_request-authorize" class="checkbox"
												   name="purchase_request-authorize" <?php echo $p->{'purchase_request-authorize'} ? "checked" : ''; ?>><label
												for="purchase_request-authorize" class="padding05"><?= lang('authorize') ?></label>
                                ...
                                <tr>
                                    ...
                                    <td>
										...
										<input type="checkbox" value="1" id="transfers-combine_pdf" class="checkbox"
											   name="transfers-combine_pdf" <?php echo $p->{'transfers-combine_pdf'} ? "checked" : ''; ?>><label
											for="transfers-combine_pdf" class="padding05"><?= lang('combine_pdf') ?></label>
										</div>		
                                    </td>
                                </tr>
                                ...
                                <td>
                                  ...
                                  <div class="col-md-4">                                    
                                    ...
                                    <div class="col-md-12">
										...
										<input type="checkbox" value="1" class="checkbox" id="product_report-inventory_valuation_detail"
                                           name="product_report-inventory_valuation_detail" <?php echo $p->{'product_report-inventory_valuation_detail'} ? "checked" : ''; ?>><label
                                        for="product_report-inventory_valuation_detail" class="padding05"><?= lang('product_report-inventory_valuation_detail') ?></label><br/>
                                        ...
                                        <input type="checkbox" value="1" class="checkbox" id="product_report-customers"
                                           name="product_report-customers" <?php echo $p->{'product_report-customers'} ? "checked" : ''; ?>><label
                                        for="product_report-customers" class="padding05"><?= lang('report_product_customers') ?></label><br/>
										
                                        <input type="checkbox" value="1" class="checkbox" id="report_transfers"
                                           name="report_transfers" <?php echo $p->{'report_transfers'} ? "checked" : ''; ?>><label
                                        for="report_transfers" class="padding05"><?= lang('report_transfers') ?></label><br/>
										
										<input type="checkbox" value="1" class="checkbox" id="report_list_using_stock"
                                           name="report_list_using_stock" <?php echo $p->{'report_list_using_stock'} ? "checked" : ''; ?>><label
                                        for="report_list_using_stock" class="padding05"><?= lang('report_list_using_stock') ?></label><br/>
										
										<input type="checkbox" value="1" class="checkbox" id="report_convert"
                                           name="report_convert" <?php echo $p->{'report_convert'} ? "checked" : ''; ?>><label
                                        for="report_convert" class="padding05"><?= lang('report_convert') ?></label><br/>										
                                  </div>
                                  </div>
                                  ...
                                  <div class="col-md-4">
                                    <div class="col-md-8" style="border-bottom: 2px solid #DDDDDD">
                                      <input type="checkbox" value="1" class="checkbox" id="sale_report-index" name="sale_report-index" <?php echo $p->{'sale_report-index'} ? "checked" : ''; ?>><label
                                    ...
                                    <div class="col-md-12">
										...
										<input type="checkbox" value="1" class="checkbox" id="sale_report-report_sale"
												...
												for="sale_report-sale_report" class="padding05"><?= lang('sale_report') ?></label><br/>
										...
										<input type="checkbox" value="1" class="checkbox" id="sale_report-delivery_detail"
												   name="sale_report-delivery_detail" <?php echo $p->{'sale_report-delivery_detail'} ? "checked" : ''; ?>><label
												for="sale_report-delivery_detail" class="padding05"><?= lang('sale_report-delivery_detail') ?></label><br/>
										...
										<input type="checkbox" value="1" class="checkbox" id="sale_report-customer"
												   name="sale_report-customer_transfers" <?php echo $p->{'sale_report-customer_transfers'} ? "checked" : ''; ?>><label
												for="sale_report-customer_transfers" class="padding05"><?= lang('sale_report-customer_transfers') ?></label><br/> 
										...
										<input type="checkbox" value="1" class="checkbox" id="sale_report-project_manager"
												   name="sale_report-project_manager" <?php echo $p->{'sale_report-project_manager'} ? "checked" : ''; ?>><label
												for="sale_report-project_manager" class="padding05"><?= lang('project_manager_report') ?></label><br/>
                                          ...
                                          <input type="checkbox" value="1" class="checkbox" id="report_profit-index"
											...
											<div class="col-md-12">
											  ...
											  <input type="checkbox" value="1" class="checkbox" id="sale_report-register"
											   name="sale_report-register" <?php echo $p->{'sale_report-register'} ? "checked" : ''; ?>>
											   	<label for="sale_report-register" class="padding05"><?= lang('sale_report-register') ?></label>
											</div>
                                        ...
                                        <div class="col-md-4">
                                          ...
                                          <div class="col-md-12">
										    ...
										    <input type="checkbox" value="1" class="checkbox" id="purchase_report-supplier"
                                                  ...
                                                  for="purchase_report-supplier" class="padding05"><?= lang('purchase_report-supplier') ?></label><br/>
