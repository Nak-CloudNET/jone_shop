                        ...
                        if ($Owner || $Admin) {
                            ?>
                                ...
                                <li class="mm_products">
                                    ...
                                    <ul>
										...
										<!--<li id="products_view_enter_using_stock" class="sub_navigation">
                                            <a class="submenu" href="<?= site_url('products/view_enter_using_stock'); ?>">
                                                <i class="fa fa-filter"></i>
                                                <span class="text"> <?= lang('list_stock_using'); ?></span>
                                            </a>
                                        </li>
								...
								<li class="mm_purchases_order">
                                    <a class="dropmenu" href="#">
                                        <i class="fa fa-star"></i>
                                        <span class="text"> <?= lang('manage_purchase_order'); ?> 
                                    </span> <span class="chevron closed"></span>
                                    </a>
                                    <ul>
										<li id="purchases_purchase_order">
								...
								<li class="mm_purchases_request">
                                    <a class="dropmenu" href="#">
                                        <i class="fa fa-star"></i>
                                        <span class="text"> <?= lang('manage_purchase_request'); ?> 
                                    </span> <span class="chevron closed"></span>
                                    </a>
                                    <ul>
										<li id="purchases_request_index">
							...
							<!--	<li class="mm_project_plan">
                                    <a class="dropmenu" href="#">
                                        <i class="fa fa-tags"></i>
                                        <span class="text"> <?= lang('manage_project_plan'); ?> </span>
                                        <span class="chevron closed"></span>
                                    </a>
                                    <ul>
                                        <li id="project_plan_index">
                                            <a class="submenu" href="<?= site_url('project_plan'); ?>">
                                                <i class="fa fa-tags"></i><span class="text"> <?= lang('list_plan'); ?></span>
                                            </a>
                                        </li>
                                        <li id="project_plan_add">
                                            <a class="submenu" href="<?= site_url('project_plan/add'); ?>">
                                                <i class="fa fa-plus-circle"></i><span class="text"> <?= lang('add_plan'); ?></span>
                                            </a>
                                        </li>
										<li id="project_plan_list_address">
                                            <a class="submenu" href="<?= site_url('project_plan/list_address'); ?>">
                                                <i class="fa fa-tags"></i><span class="text"> <?= lang('list_address'); ?></span>
                                            </a>
                                        </li>
                                        <li id="project_plan_list_plan">
                                            <a class="submenu" href="<?= site_url('project_plan/add_address'); ?>">
                                                <i class="fa fa-plus-circle"></i><span class="text"> <?= lang('add_address'); ?></span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>-->
                                    ...
                                    <ul>
                                        ...
                                        <li id="jobs_by_csv">
                                            <a class="submenu" href="<?= site_url('jobs/jobs_by_csv'); ?>">
                                                <i class="fa fa-plus-circle"></i><span class="text"> <?= lang('import_jobs'); ?></span>
                                            </a>
                                        </li>										
										
                                    	<li id="jobs_job_activities">
                                            <a class="submenu" href="<?= site_url('jobs/job_activities'); ?>">
                                                <i class="fa fa-star-o"></i><span class="text"> <?= lang('job_activities'); ?></span>
                                            </a>
                                        </li>   
                                    	<li id="jobs_job_employees">
                                            <a class="submenu" href="<?= site_url('jobs/job_employees'); ?>">
                                                <i class="fa fa-star-o"></i><span class="text"> <?= lang('job_employees'); ?></span>
                                            </a>
                                        </li>
                                        <li id="jobs_marchines">
                                            <a class="submenu" href="<?= site_url('jobs/marchines'); ?>">
                                                <i class="fa fa-star-o"></i><span class="text"> <?= lang('list_marchine'); ?></span>
                                            </a>
                                        </li>
                                        ...
                                        <li class="mm_reports">
                                            ...
                                            <ul>
												...
												<li class="mm_profit_report">
													...
													<li id="reports_paid_by_report">
														<a href="<?= site_url('reports/paid_by_report') ?>">
																<i class="fa fa-money"></i><span class="text"> <?= lang('paid_by_report'); ?></span>
														</a>
													</li>
													<?php if (POS) { ?>
												...
												<ul>  
														<?php } ?>
															<li id="reports_product_value">
				                                                <a href="<?= site_url('reports/product_value') ?>">
				                                                    <i class="fa fa-barcode"></i><span class="text"> <?= lang('product_value_report'); ?></span>
				                                                </a>
				                                            </li>
								...
								<li class="mm_reports">
									...
									<ul>
										...
										<li class="mm_product_report">
											...
											<ul>
												<?php if($GP['product_report-product_value']) { ?>
                                                    <li id="reports_product_value">
                                                        <a href="<?= site_url('reports/product_value') ?>">
                                                            <i class="fa fa-barcode"></i><span class="text"> <?= lang('product_value_report'); ?></span>
                                                        </a>
