...
border: 1px solid #000000;">
		...
		<p><b>Dear</b>&nbsp;&nbsp;&nbsp;&nbsp; Sir/Madam<br/> We thank you for your enquiry and we are pleased to submit the following quote for your kind consideration</p><br/>
			...
			<?php if ($inv->order_discount != 0) {
                        echo '<tr><td colspan="' . 6 . '" style="text-align:right; padding-right:10px;;">' . lang("order_discount") . ' (' . $default_currency->code . ')</td><td style="text-align:right; padding-right:10px;"> $ ' . $this->erp->formatMoney($inv->order_discount) . '</td><td></td></tr>';
                    }
                    ?>
                    <?php if ($inv->shipping != 0) {
                        echo '<tr><td colspan="' . 6 . '" style="text-align:right; padding-right:10px;;">' . lang("shipping") . ' (' . $default_currency->code . ')</td><td style="text-align:right; padding-right:10px;"> $ ' . $this->erp->formatMoney($inv->shipping) . '</td><td></td></tr>';
                    }
                    ?>
				</tr>
				<tr>
					...
					<td  style="text-align:right;"> $  <?= $this->erp->formatMoney(($tt + $inv->shipping) - $inv->order_discount); ?></td>
					<td></td>
					
				</tr>
					<td colspan="6" style="text-align:right;">VAT 10%</td>
				...
				<tr>
					<td colspan="6" style="text-align:right;">Total Amount W/O VAT:</td>
					
					<td  style="text-align:right;"> $ <?=$this->erp->formatMoney((($tt + $inv->shipping) - $inv->order_discount) + $inv->order_tax);?></td>
					<td></td>
