    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open_multipart("purchases_request/add/", $attrib)
                ?>
				<div class="row">
                    <div class="col-lg-12">
						...
						<?php if ($Owner || $Admin || !$this->session->userdata('warehouse_id')) { ?>
							<div class="col-md-4">
								<div class="form-group">
									...
									echo form_dropdown('warehouse', '', (isset($_POST['warehouse']) ? $_POST['warehouse'] : $Settings->default_warehouse), 'id="powarehouse" class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("warehouse") . '" required="required" style="width:100%;" ');
									?>
								</div>
							</div>
                                    ...
                                    <div class="col-md-4" style="display: none;">
                                        <div class="form-group">
                                            ...
                                            <?php if ($Owner || $Admin || $GP['suppliers-add']) { ?><div class="input-group"><?php } ?>
                                                <input type="hidden" name="supplier1" value="" id="posupplier"
                                ...
                                <div class="form-group" style="margin-bottom:0;">
                                    <div class="input-group wide-tip">
                                        ...
                                        <div class="input-group-addon" style="padding-left: 10px; padding-right: 10px;">
											...
											<a href="<?= site_url('purchases_request/add');?>" class="gos" ></a>
										</div>
                                        <?php } ?>
                                    </div>
                                </div>
