                ...
                <div class="buttons">
                    ...
                    <div class="btn-group btn-group-justified">
                        <?php if($Owner || $Admin || $GP['purchase_request-authorize']) { ?>
    						...
    						<div class="btn-group">
                                <a href="<?= site_url('purchases_request/Unapproved/' . $inv->id) ?>" class="tip btn btn-primary" title="<?= lang('unauthorize') ?>">
                                    <i class="fa fa-check"></i>
                                    <span class="hidden-sm hidden-xs"><?= lang('unauthorize') ?></span>
                                </a>
                            </div>
                            <?php }else if($inv->order_status != 'completed'&& $inv->status == 'requested'){ ?>
    						<div class="btn-group">
                                <a href="<?= site_url('purchases_request/update_purchases_request/' . $inv->id) ?>" class="tip btn btn-primary" title="<?= lang('authorize') ?>">
                                    <i class="fa fa-check"></i>
                                    <span class="hidden-sm hidden-xs"><?= lang('authorize') ?></span>
                                </a>
                            </div>
    						<?php }?>
                        <?php } ?>
						...
						<div class="btn-group">
                            <a href="<?= site_url('purchases_request/invoice/' . $inv->id) ?>" target="_blank" class="tip btn btn-primary" title="<?= lang('print_invoice') ?>">
                        ...
                        <div class="btn-group">
                            <a href="<?= site_url('purchases_request/view/' . $inv->id) ?>" class="tip btn btn-primary" title="<?= lang('view') ?>">
