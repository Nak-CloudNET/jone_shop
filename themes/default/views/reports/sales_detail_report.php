                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-condensed table-striped">
						...
						<?php 
							...
							?>
								...
								<?php 
									...
									if($sale->type == 1){
										foreach($sales_detail as $sale_detail){										
                                            ...
                                            $total_tax += $sale_detail->item_tax;
								...
								<tr style="font-weight:bold;">
									<td></td>
									<td colspan="6" class="info-reference_no right"></td>
									<td class="right"><?= lang("total")?> :</td>
                                    <td class="right">( <?= $this->erp->formatMoney($total_tax); ?> )</td>
                                    <td class="right">( <?= $this->erp->formatMoney($total_discount); ?> )</td>
								...
								<tr style="font-weight:bold;">
									<td></td>
									<td colspan="7" class="info-reference_no right"><?= lang("order_discount")?> :</td>
                                    <td></td>
                                    <td></td>
									<td></td>
								...
								<tr style="font-weight:bold;">
									<td></td>
									<td colspan="7" class="info-reference_no right"><?= lang("shipping")?> :</td>
                                    <td></td>
                                    <td></td>
									<td></td>
								...
								<tr style="font-weight:bold;">
                                    ...
                                    <td></td>
									<td></td>
									<td colspan="5" class="info-reference_no right"><?= lang("subtotal")?> :</td>
                                    <td></td>
                                    <td></td>
									<td class="right"><?= $this->erp->formatMoney($total_costs); ?></td>
								...
								<tr style="font-weight:bold; display:none;">
									<td></td>
									<td colspan="7" class="info-reference_no right"><?= lang("total_amount")?> :</td>
									<td></td>
                        ...
                        <tfoot>
							...
							<tr>
								<th colspan="8"  style="color:#0586ff"class="right info-foot"><?= lang("total") ?>  : </th>
                                <th class="text-right">( <?= $this->erp->formatMoney($g_total_tax2); ?> )</th>
                                <th class="text-right">( <?= $this->erp->formatMoney($g_total_disc); ?> )</th>
							...
							<tr>
								<th colspan="8" class="right info-foot" style="color:#0586ff"><?= lang("total_order_discount"); ?> : </th>							
                                <th></th>
                                <th></th>
								<th></th>
							...
							<tr>
								<th colspan="8" class="right info-foot" style="color:#0586ff"><?= lang("total_shipping"); ?> : </th>							
                                <th></th>
                                <th></th>
								<th></th>
							...
							<tr>
								<th colspan="8" class="right info-foot" style="color:#0586ff"><?= lang("total_overhead"); ?> : </th>
                                <th></th>
                                <th></th>
							...
							<tr>
								<th colspan="8" style="color:#0586ff" class="right info-foot" ><?= lang("total_gross_margin"); ?> : </th>
                                <th></th>
                                <th></th>
