...
<script>
    $(document).ready(function () {
        var oTable = $('#SlRDatas').dataTable({
            ...
            "aoColumns": [
			{"bSortable": false, "mRender": checkbox},{"mRender": fld},null,null,null,{"bSearchable": false,"mRender": formatQuantity},{"sClass":"center"}],
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                ...
                nCells[5].innerHTML = currencyFormat(parseFloat(quantity));
            }
