...
<?= ($m == 'transfers' && ($v == 'add' || $v == 'edit' || $v == 'received_transfer')) ? '<script type="text/javascript" src="' . $assets . 'js/transfers.js"></script>' : ''; ?>
...
<?= ($m == 'sale_order' && ($v == 'add_sale_order' || $v == 'edit_sale_order')) ? '<script type="text/javascript" src="' . $assets . 'js/edit_sale_order.js"></script>' : ''; ?>
...
<?= ($m == 'products' && ($v == 'using_stock' || $v == 'edit_using_stock_by_id')) ? '<script type="text/javascript" src="' . $assets . 'js/using_stock.js"></script>' : ''; ?>
