    ...
    <div id="receipt-data">
        ...
        <div class="text-center">
			...
			<table style="width: 100%; margin-top: 5px; border-bottom: 1px solid black;">
				<tr>
					<td class="text-left"><b>Total (<?= $default_currency->code; ?>)</b></td>
					<td style="text-align:right;"><b>$ <?=$this->erp->formatMoney($inv->total);?></b></td>
				</tr>
				<tr>
			...
			<table class="received" style="width:100%;margin-top: 5px;">
				<tr>
					...
					<td style="text-align:right;"><b>$ <?= $this->erp->formatMoney($inv->recieve_usd); ?></b></td>
				</tr>
				<tr>
					<td class="text-left">
						<?php
					...
					<td style="text-align:right;">R <?= $this->erp->formatMoney($inv->recieve_real); ?></td>
				</tr>
				<?php
				
				if($inv->paid-($inv->total+$inv->order_tax-$inv->order_discount) >= 0){?>
				<tr>
					<td class="text-left"><b>Change Given (<?= $default_currency->code; ?>)</b></td>
					<td style="text-align:right;"><b>$ <?=$this->erp->formatMoney($inv->pos_balance)?></b></td>
