			...
			<div class="quick-menu">
				<div id="proContainer">
					<div id="ajaxproducts" style="height: 260px !important;">
						...
						<div class="btn-group btn-group-justified btn_gift_card" style="position:relative; margin:auto;bottom:30px;width:35%;">
							<div class="btn-group" >
		...
		<div class="c1">
            <div class="pos">
				...
				<div id="pos">
                            ...
                            <div id="left-middle">
								...
								<?php if ($layout == 3) { ?>
                                    <table class="table items table-striped table-bordered table-condensed table-hover"
                                           id="posTable" style="margin-bottom: 0; font-size: 16px;">
								<?php } else { ?>
									<table class="table items table-striped table-bordered table-condensed table-hover"
                            ...
                            <div id="left-bottom">
                                <table id="totalTable"
									...
									<tr>
                                        ...
                                        <td class="text-right">
                                            <?= lang('rate'); ?> <span style="padding: 5px 10px;font-size: 16px; font-weight:bold;" id="khmer_rate"><?php echo $exchange_rate->rate?number_format($exchange_rate->rate):0 ?>  ៛</span>
                                        </td>
                                ...
                                <div id="botbuttons" style="text-align:center;">
                                    ...
                                    <div class="btn-group btn-group-justified">
                                        <div class="btn-group">
                                            <div class="btn-group btn-group-justified">
                                                <div class="btn-group">
                                                    <button type="button" title="Cancel Order - <?= $pos_settings->cancel_sale ?>" style="height:68px;" class="btn btn-danger" id="reset">
                    					...
                    					<div class="btn-group">
                                            <div class="btn-group btn-group-justified">
                                                <div class="btn-group">
													...
													<button type="button" title="Print Order - <?= $pos_settings->print_items_list ?>" class="btn btn-primary" id="print_order_drink" style="width:50%;">
                                                        <i class="fa fa-print"></i> <?= lang('order_drink'); ?>
                                                    </button>
                   ...
                   <?php if ($layout != 2 && $layout != 3 && $layout != 5) {?>
                    <div id="cp">
                        <div id="cpinner" style="padding:0;">
                            <div class="quick-menu">
                                <div id="proContainer">
...
<?php } ?>
	...
	?>
    <button type="button" id="suspend" class="btn btn-danger open-suspend"><?= lang('suspend') ?>&nbsp;</button>
	<?php } ?>
							...
							<div class="col-md-12 col-sm-9" style="padding:0;">
								<div class="font16">
									<table class="table table-bordered table-condensed table-striped" style="font-size: 1.2em; font-weight: bold; margin-bottom: 0;">
										<tbody>
											<tr>
												<th width="50%" style="text-align:left;"><?= lang("currency"); ?></th>
											...
											<tr>
												<td width="50%" style="height: 50px;"><?= lang("total_items"); ?></td>
											...
											<tr>
												<td width="50%" style="height: 50px;"><?= lang("total_payable"); ?></td>
											...
											<tr>
												<td width="50%" style="height: 50px;"><?= lang("paid_amount"); ?></td>
											...
											<tr>
												<td  rowspan="2" width="50%" style="text-align:left;"><?= lang("remaining"); ?></td>
											...
											<tr>
												<td  rowspan="2" width="50%" style="text-align:left;"><?= lang("change"); ?></td>
												<td class="text-right"><span id="change_1">0.00</span></td>
												<?php
												$this->db->select('*');
												$this->db->from('erp_currencies');
												$this->db->where('code != "USD" and in_out = 0');
											...
											<div class="form-group">
												...
												<?php
													...
													if ($Owner || $Admin) {
														...
														echo form_dropdown('bank_account', $ubank, '', 'id="bank_account_1" class="ba form-control kb-pad bank_account"');
													}
												?>
											</div>
										</div>
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
							...
							<input type="hidden" class="form-control" value="<?= $phone ?>" id="bill_phone">
							<input type="hidden" class="form-control" value="<?= $email ?>" id="bill_email">
							<input type="hidden" class="form-control" value="<?= $vat_no ?>" id="bill_vat">
							<input type="hidden" class="form-control" value="<?= $invoice_footer ?>" id="invoice_footer">
							<input type="hidden" class="form-control" value="<?= $tax->name ?>" id="tax_name">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    echo form_dropdown('order_tax_input', $tr, "", 'id="order_tax_input" class="form-control pos-input-tip" style="width:100%;" hello="aaaaaaa" ');
                    ?>
                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
		localStorage.setItem('wifi_code', '<?=$wifi_code;?>');
		localStorage.setItem('bill_addr', '<?= $bill_addr; ?>');
...
//////////////
		...
		*/
        ...
        $(document).on('click', '#submit-sale', function () {
			...
			if(chks == true){
				bootbox.confirm("<?= lang('are_you_sure_want_to_sale_it'); ?>", function (res) {
					if (res == true) {
        ...
        var mywindow = window.open('', 'erp_pos_print', 'height=800,width=450');
					...
					// mywindow.document.write('<div style="text-align:center"><img src="<?= base_url() . 'assets/uploads/logos/' . $biller->logo; ?>" alt="<?= $biller->company; ?>" /> ');
					 // mywindow.document.write('<?php
						echo '<p style="text-align:center">' . $biller->address . " " . $biller->city . " " . $biller->postal_code . " " . $biller->state . " " . $biller->country ."<br>".$biller->invoice_footer."".
