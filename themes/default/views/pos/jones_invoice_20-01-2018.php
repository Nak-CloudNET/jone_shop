        ...
        <div class="text-center">
			...
			<table class="received" style="width:100%;margin-top: 5px;">
				<tr>
					...
					<td style="text-align:right;">$ <?= $this->erp->formatMoney($totalamount=$inv->total); ?></td>
				</tr>
								...
								<th colspan="<?= $colspan + 2 ?>">
									...
									?>
										<table style="width: 100%;">
											...
											<tr>
												<th style="border-left:2px solid #000;border-top:2px solid #000;border-right:none;border-bottom:2px solid #000; padding-right: 12px;width:64%;"  class="text-right">Received (USD) :</th>
												<th style="border-right:2px solid #000;border-top:2px solid #000;border-left:none;border-bottom:2px solid #000;" class="text-right"><?= $this->erp->formatMoney($payment->pos_paid); ?></th>
											</tr>
											<?php
												if($inv->other_cur_paid){
											?>
				...
				?>
							...
							<tr>
								...
								<th style="border-top:2px dotted #000" class="text-right"><?= number_format(abs((($payment->pos_paid+$money_kh) - $totalamount)*(($pos_settings->in_out_rate) ? $outexchange_rate->rate:$exchange_rate->rate))) . ' ៛' ; ?></th>
							</tr>
				<?php
						}
					}
