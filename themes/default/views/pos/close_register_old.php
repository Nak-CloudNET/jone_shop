<?php
	// $this->erp->print_arrays($register_close_time);
?>
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title"
                id="myModalLabel"><?= lang('close_register') . ' (' . $this->erp->hrld($register_open_time ? $register_open_time : $this->session->userdata('register_open_time')) . ' - ' . $register_close_time . ')'; ?></h4>
        </div>
            ...
            <table width="100%" class="stable">
                <tr>
                    ...
                    <td style="text-align:right; border-bottom: 1px solid #EEE;">
						<h4><span><?= $this->erp->formatMoney($cash_in_hand ? $cash_in_hand : $this->session->userdata('cash_in_hand')); ?></span></h4>
					</td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="text-align:right; border-bottom: 1px solid #EEE;">
						<h4><span><?= $this->erp->formatMoney($cashsales->paid ? $cashsales->paid : '0.00') . ' (' . $this->erp->formatMoney($cashsales->total ? $cashsales->total : '0.00') . ')'; ?></span></h4>
					</td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="text-align:right;">
                        <h4>
                            <span>
                                <strong><?= $this->erp->formatMoney($totalsales->paid - $refunds->returned - $expenses->total); ?></strong>
                                <!-- <strong><?= $cashsales->paid ? $this->erp->formatMoney(($cashsales->paid + ($this->session->userdata('cash_in_hand')) - $expense) - ($refunds->returned ? $refunds->returned : 0)) : $this->erp->formatMoney($this->session->userdata('cash_in_hand') - $expense); ?></strong> -->
                            </span>
                        </h4>
                    </td>
                </tr>
            ...
            <div class="row no-print">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <?= form_input('total_cash_submitted', (isset($_POST['total_cash_submitted']) ? $_POST['total_cash_submitted'] : $this->erp->formatMoney($total_cash)), 'class="form-control input-tip" id="total_cash_submitted" required="required"'); ?>
                    </div>
                    <div class="form-group">
