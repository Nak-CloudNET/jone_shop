    ...
    <div id="receipt-data">
        <div class="text-center">
			...
			<table style="width: 100%; margin-top: 5px;">
				<tr>
					<td style="text-align:left;width:25%; background-color: #CCC !important;"><strong>សរុប</strong></td>
					<td style="text-align:right;width:35%; background-color: #CCC !important;"><strong>Sub Total (<?= $default_currency->code; ?>) :</strong></td>
					<td style="text-align:right; background-color: #CCC !important;"><strong>$ <?=$this->erp->formatMoney($sub_total)?></strong></td>
				</tr>
				<tr>
					<td style="text-align:left;">ពន្ធ</td>
					<td style="text-align:right;width:35%;">Order Tax (<?= $default_currency->code; ?>) :</td>
					<td style="text-align:right;">$ <?=$this->erp->formatMoney($inv->product_tax)?></td>
				</tr>
				<tr>
				...
				<tr>
					<td style="text-align:left; background-color: #CCC !important;"><strong>សរុបចុងក្រោយ</strong></td>
					<td style="text-align:right;width:40%; background-color: #CCC !important;"><strong>Grand Total (<?= $default_currency->code; ?>) :</strong></td>
					<td style="text-align:right; background-color: #CCC !important;"><strong>$ 
					<?php
			...
			<tr style="display:none;">
				...
				?>
                    ...
                    <tr>
                        ...
                        <th style="border-bottom:2px solid #000;border-right:2px solid #000;border-left:none;" class="text-right"><?= $this->erp->formatMoney($inv->recieve_usd * $inv->other_cur_paid_rate) ; ?></th>
                    </tr>
				...
				<?php
					...
					<tr>
                        <th style="border-top:2px dotted #000;padding-right: 12px; background-color: #CCC !important;" class="text-right"><strong><?= lang("change_amount_us"); ?></strong></th>
                        <th style="border-top:2px dotted #000; background-color: #CCC !important;" class="text-right"><strong>
						<?php
