...
<div id="wrapper">
    <div id="receiptData">
        ...
        <div class="text-center">
            ...
            <button type="button" class="close pull-right" data-dismiss="modal" aria-hidden="true"><i class="fa fa-2x"></i>&times;</button>
			...
			<table class="received" style="width:100%;margin-top: 5px;">
				<tr>
					...
					<th style="border-right:2px solid #000;border-top:2px solid #000;border-left:none; text-align: right;" class="text-right">$<?= $this->erp->formatMoney($total); ?></th>
				</tr>
				...
				<tr>
					...
					<th>:</th>
					<th style="border-right:2px solid #000;border-top:none;border-left:none; text-align: right;" class="text-right">$<?= $this->erp->formatMoney($paid->amount); ?></th>
				</tr>
				<tr>
					...
					<th style="border-right:2px solid #000;border-top:none; border-bottom:2px solid;border-left:none; text-align: right;" class="text-right">$<?= $this->erp->formatMoney($total-$paid->amount); ?></th>
				</tr>
				<? }?>
			</table>
