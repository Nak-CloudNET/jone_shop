...
<div class="row">
	<div class="col-md-12">
		...
		if ($inv->payment_status == 'paid') {
			...
			echo '<div class="alert alert-warning">' . lang('payment_status_not_paid') . ' ' . lang('payment_status') . ': <strong>' . $inv->payment_status . '</strong> & ' . lang('paid_amount') . ' <strong>' . $this->erp->formatMoney($inv->deposit + $inv->paid) . '</strong></div>';
		}
		?>
	</div>
</div>
