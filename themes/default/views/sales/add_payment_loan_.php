<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo form_open_multipart("sales/add_payment_loans/" . $sale_id."/".$loan_id, $attrib); ?>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <?= form_input('reference_no', (isset($_POST['reference_no']) ? $_POST['reference_no'] : $reference), 'class="form-control tip" id="reference_no"'); ?>
                    </div>
                </div>
						...
						<div class="row">
                            <div class="col-sm-6">
                                <div class="payment">
                                    <div class="form-group">
                                        ...
                                        <input name="principle" type="text" id="principle" value="<?=
										 $this->erp->formatDecimal($loan_data->payment-$loan_data->interest)?>"
                                               class="pa form-control kb-pad principle" required="required"/>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input name="interest" type="text" id="interest" value="<?= $this->erp->formatDecimal($loan_data->interest)?>"
                                               class="pa form-control kb-pad interest" required="required"/>
                                </div>
                            </div>
                                ...
                                <div class="payment">
                                    <div class="form-group">
                                        ...
                                        <input name="amount-paid" type="text" id="amount_1"
                                               value="<?=$this->erp->formatDecimal($loan_data->payment-$loan_data->interest)?>"
