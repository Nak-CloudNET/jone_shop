    ...
    $(document).ready(function () {
        var oTable = $('#RESLData').dataTable({
            ...
            "aoColumns": [{"bSortable": false,
                "mRender": checkbox
                }, {"mRender": fld}, null, {"mRender": nl2br}, null, null, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}],
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                ...
                for (var i = 0; i < aaData.length; i++) {
                    ...
                    tbalance += parseFloat(aaData[aiDisplay[i]][10]);
                }
