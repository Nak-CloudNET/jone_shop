        ...
        <div class="col-lg-12">
                ...
                <table class="table table-bordered table-striped" style="width: 100%;">
                    <thead  style="font-size: 13px;">
						<tr>
                            ...
                            <th><?= lang("number_kh2"); ?><br><?= lang("piece");  ?></th> 
                        ...
                        foreach ($rows as $row):
                                ...
                                if($row->option_id){
                                   ...
                                   $getvar = $this->sales_model->getAllProductVarain($row->product_id);
									// $this->erp->print_arrays($getvar);
									// $var = $this->sales_model->getMaxqty($row->option_id);
									// $var1 = $this->sales_model->getVarain($var->mva);									
									// $str_unit = $var1->name;
										// $i = 1;
										// $team = " ";
            ...
            <div class="row" style="margin-top: 50px !important">
                <div class="col-sm-3 col-xs-3">
                    <center>
                    <p><?= lang('receiver_kh'); ?></p>
                    <hr style="border:1px solid #000; width:200px;" />
                    </center>
                </div>
                <div class="col-sm-3 col-xs-3">
                    <center>
