...
<html>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-10 col-lg-offset-1">
				<div class="col-lg-4 col-sm-4" style="border-radius: 10px 10px 10px 10px;-moz-border-radius: 10px 10px 10px 10px;-webkit-border-radius: 10px 10px 10px 10px;border: 1px solid #000000;height:130px;width:55%;padding-top:5px;">
					<table>
						<tr>
							<td><b>Bill To</b></td>
							<td><b>: <?=$sale_order->biller;?></b></td>
						</tr>
						<tr>
							<td>Address</td>
							<td>: <?=$sale_order->address;?></td>
						</tr>
						<tr>
							<td>Att</td>
							<td><b>: <?=$sale_order->name;?></b></td>
						</tr>
						<tr>
							<td>Tel</td>
							<td><b>: <?=$sale_order->phone;?></b></td>
						</tr>
						<tr>
							<td>Email</td>
							<td>: <?=$sale_order->email;?></td>
						</tr>
					</table>
				</div>
				<div class="col-lg-4 col-lg-offset-2 col-sm-4 col-sm-offset-2" style="border-radius: 10px 10px 10px 10px;-moz-border-radius: 10px 10px 10px 10px;-webkit-border-radius: 10px 10px 10px 10px;border: 1px solid #000000;height:130px;width:42%;margin-left:10px;padding-top:25px;">
					<table id="tb3">
						<tr>
							<td><b>No.</b></td>
				...
				<table class="table table-bordered table-hover table-striped print-table order-table">
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-left" style="text-align: center; vertical-align: top">
								<?=$row->product_code.' - ';?>
					...
					<tfoot>
						...
						<tr>
							...
							<td style="text-align: right; vertical-align: top">
								<div class="col-xs-1" style="text-align: left; vertical-align: top;">$</div>
								<div style="text-align: right; vertical-align: top"><?=$this->erp->formatMoney($deposit->amount);?></div>
							</td>
						</tr>
						<tr>
