                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?php } else if($this->session->userdata('biller_id')){ ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    echo form_dropdown('biller', $bl, $biller_id, 'id="pnbiller" data-placeholder="' . lang("select") . ' ' . lang("biller") . '" required="required" class="form-control input-tip select" style="width:100%;pointer-events: none;"');
                                    ?>
                                </div>
                            </div>
                        <?php } ?>
						...
						<div class="col-md-4">
							<div class="form-group">
								<?= lang("plan", "plan") ?>
								<input id="plan" type="text" name="plan" value="<?= $plan;?>" class="form-control" required/>
							</div>
						</div>
                                        ...
                                        <thead>
											<tr>
												...
												<?php if($setting->show_code == 1 && $setting->separate_code == 1) { ?> 
													...
													<th class="col-md-5"><?= lang("product_name"); ?></th>
												<?php } ?>
												...
												<?php if($setting->show_code == 0) { ?>
													<th class="col-md-9"><?= lang("product_name"); ?></th>
												<?php } ?>
                        ...
                        <div class="row" id="bt">
                            <div class="col-sm-12">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <?= lang("note", "pnnote"); ?>
                                        <?php echo form_textarea('note', $note, 'class="form-control" id="pnnote" style="margin-top: 10px; height: 100px;"'); ?>
                                    </div>
                                </div>
                            </div>
						</div>
