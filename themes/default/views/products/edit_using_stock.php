<script type="text/javascript">
	...
	<?php if($items){?>
		...
		localStorage.setItem('from_location', '<?= $where; ?>');
					...
					<div class="col-md-4">
						...
						<div class="form-group">
							...
							<!-- <div class="input-group">   -->
								...
								<input type="hidden"  name="temp_reference_no"  id="temp_reference_no" value="<?= $refer ?>" />
						...
						<div class="form-group all">
                            ...
                            <?php
								...
								echo form_dropdown('from_location', $wh, $where, 'class="form-control"   required  id="from_location" placeholder="' . lang("select") . ' ' . lang("location") . '" style="width:100%"')
                            ?>
                        </div>
					</div>
					<div class="col-md-4">
						...
						<div class="form-group">
                            ...
                            echo form_dropdown('shop', $billers, $using_stock->shop, 'class="form-control"   required  id="shop" placeholder="' . lang("select") . ' ' . lang("shop") . '" style="width:100%"')
                            ?>
						</div>
					</div>
					<div class="col-md-4">			
						...
						<div class="table-responsive">
							<table id="UsData" class="table table-bordered table-hover table-striped table-condensed reports-table">
								<thead>
									...
									<!-- 	<th style="width:14% !important;"><?= lang("unit_cost"); ?></th> -->
