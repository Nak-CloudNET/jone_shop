    ...
    $(document).ready(function () {
        oTable = $('#PRData').dataTable({
            ...
            "aoColumns": [
                ...
                <?php } ?>
                {"mRender": formatQuantity}, null, {"mRender": formatQuantity}, {"bSortable": false}
            ],
			"aoColumnDefs": [
...
<div class="box">
    <div class="box-header">
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <?php if ($Owner || $Admin || $GP['products-add'] || $GP['products-print_barcodes'] || $GP['products-sync_quantity'] || $GP['products-export'] || $GP['products-import'] || $GP['products-adjustments'] || $GP['products-import_quantity'] || $GP['products-import_price_cost']) { ?>
                <li class="dropdown">
