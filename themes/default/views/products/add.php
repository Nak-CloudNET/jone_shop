            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-5">
                    ...
                    <div class="form-group all">
                        ...
                        <?= form_input('name', (isset($_POST['name']) ? $_POST['name'] : ($product ? $product->name : '')), 'class="form-control" id="name" required '); ?>
                    </div>
					<div class="form-group all">
                    ...
                    <div class="form-group all">
                        ...
                        <?= form_input('code', (isset($_POST['code']) ? $_POST['code'] : ($product ? $product->code : '')), 'class="form-control" id="code"  required') ?>
                    ...
                    <div class="form-group">
						...
						<?php if ($Owner || $Admin) { ?><div class="input-group"><?php } ?>
								...
								echo form_dropdown('category', $cat, (isset($_POST['category']) ? $_POST['category'] : ($product ? $product->category_id : '')), 'class="form-control select" id="category" placeholder="' . lang("select") . " " . lang("category") . '" required  style="width:100%" required="required"')
								?>
                    ...
                    <div class="form-group all">
                       ...
                       <div class="input-group"> <?php
                        ...
                        echo form_dropdown('unit', $ut, (isset($_POST['unit']) ? $_POST['unit'] : ($product ? $product->unit_id: '')), 'class="form-control select" id="unit" placeholder="'.lang('select_units').'" required style="width:100%;"');
                        ?>
						           <div class="input-group-addon no-print" style="padding: 2px 5px;"><a
									href="<?= site_url('system_settings/add_unit'); ?>" id="add-supplier"
									class="external" data-toggle="modal" data-target="#myModal"><i
										class="fa fa-2x fa-plus-circle" id="addIcon"></i></a></div>
						</div>
                ...
                <div class="col-md-6 col-md-offset-1">
					...
					<div class="form-group">
                        ...
                        <?php
                        $shop[] = 'SELECT --';
                        echo form_dropdown('shop', $shop, (isset($_POST['shop']) ? $_POST['shop'] : ($product ? $product->type : '')), 'class="form-control" id="shop"');
                        ?>
                    </div>
					-->
                                ...
                                <table id="attrTable" class="table table-bordered table-condensed table-striped" style="<?= $this->input->post('attributes') || $product_options ? '' : 'display:none;'; ?>margin-bottom: 0; margin-top: 10px;">
									...
									?>
                                            <tr class="attr">
												...
												<td class="price text-right"><input type="hidden" name="attr_price[]" value="<?= $this->erp->formatQuantity($option->price);?>"><span><?= $this->erp->formatQuantity($option->price);?></span></span></td>
